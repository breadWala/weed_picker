...
<button
onpointerdown="event.preventDefault();socket.send('F');"
onpointerup="socket.send('S')"
onpointerleave="socket.send('S')">
Forward
</button>

<button onclick="socket.send('S')">
STOP
</button>

<button
onpointerdown="event.preventDefault();socket.send('Z');"
onpointerup="socket.send('S')"
onpointerleave="socket.send('S')">
Reverse
</button>
...
<button
onpointerdown="event.preventDefault();socket.send('L');"
onpointerup="socket.send('S')"
onpointerleave="socket.send('S')">
Left
</button>
...
<button
onpointerdown="event.preventDefault();socket.send('R');"
onpointerup="socket.send('S')"
onpointerleave="socket.send('S')">
Right
</button>
